    ...
    <div>
      <div className="sm:flex justify-between gap-2 items-center py-4">
        <Input
          ...
          className=" sm:w-[200px] bg-dark-2 placeholder:text-white"
        />
        <div className="py-2 sm:visible flex-1 text-[9px] text-sm pl-2">
        ...
        <div className="flex gap-2">
          ...
          <div className="flex items-center space-x-2 text-dark-1">
            <Button
              variant="outline"
